/* ==========================================================================
   RefSim — Base de datos de jugadas (Reglas del Juego IFAB)
   --------------------------------------------------------------------------
   Este archivo expone `situacionesDB`, el banco de 50 jugadas compartido por
   el Modo Práctica y el Modo Examen Oficial. Cárgalo con <script> normal
   (no es un módulo) ANTES de game.js en cualquier página que use el motor
   de juego.
   ========================================================================== */
const situacionesDB = [
    {
